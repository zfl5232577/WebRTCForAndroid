...
abstract class AbstractConnectionProvider implements ConnectionProviderImp {
    ...
    protected final LifecycleEvent mHeartBeat;

    AbstractConnectionProvider() {
        mLifecycleStream = PublishSubject.create();
        mMessagesStream = PublishSubject.create();
        mHeartBeat = new LifecycleEvent(LifecycleEvent.Type.HeartBeat);
    }
