 ...
 * <p>
 * You can add own relay, just implement ConnectionProviderImp for you stomp transport,
 * such as web socket.
 * <p>
...
public class Stomp {
    ...
    public static StompClient over(@NonNull ConnectionProvider connectionProvider, String uri, @Nullable Map<String, String> connectHttpHeaders, @Nullable OkHttpClient okHttpClient) {
        ...
        throw new IllegalArgumentException("ConnectionProviderImp type not supported: " + connectionProvider.toString());
    }

    private static StompClient createStompClient(ConnectionProviderImp connectionProvider) {
