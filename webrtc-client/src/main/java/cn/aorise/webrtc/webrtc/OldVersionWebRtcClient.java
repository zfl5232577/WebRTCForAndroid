...
@Deprecated
public class OldVersionWebRtcClient {
    ...
    public OldVersionWebRtcClient(Context context, EglBase.Context renderEGLContext, PeerConnectionParameters peerConnectionParameters, PeerConnectionListener peerConnectionListener) {
