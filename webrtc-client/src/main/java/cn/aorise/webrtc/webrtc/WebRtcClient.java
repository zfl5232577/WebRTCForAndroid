...
public class WebRtcClient {
    ...
    public static class PeerConnectionParameters {
        ...
        public int videoWidth = HD_VIDEO_WIDTH;
        public int videoHeight = HD_VIDEO_HEIGHT;
        public int videoFps = 30;
        public int videoMaxBitrate = 1700;
        public String videoCodec = VIDEO_CODEC_H264;
        ...
        public boolean useLegacyAudioDevice = false;
        private DataChannelParameters dataChannelParameters;

        public PeerConnectionParameters(boolean isVideoCall, boolean loopback, int screenHeight, int screenHeight1, int i) {
        ...
        public void setUseLegacyAudioDevice(boolean useLegacyAudioDevice) {
     ...
     */
    public WebRtcClient(Context appContext, EglBase eglBase,
    ...
    private void createPeerConnectionInternal() {
        ...
        queuedRemoteCandidates = new CopyOnWriteArrayList<>();
        queuedLocalCandidates = new CopyOnWriteArrayList<>();

        PeerConnection.RTCConfiguration rtcConfig =
                new PeerConnection.RTCConfiguration(ChatClient.getInstance().getIceServers());
